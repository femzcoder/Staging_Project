    ...
    <div className='space-y-6'>
      ...
      <div>
        <div className='flex items-center gap-2 mb-4'>
           <Button className='rounded-3xl text-white'>Adhoc</Button>
           <Button variant={'outline'} className='rounded-3xl '>Scheduled</Button>
           <Button variant={'outline'} className='rounded-3xl '>Uncompleted</Button>
        </div>
        <Grid2Container>
